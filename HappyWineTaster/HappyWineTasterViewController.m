...
@interface HappyWineTasterViewController ()
...
- (void)viewDidLoad
{
    ...
    //self.view.backgroundColor = [UIColor colorWithRed:255./255 green:182./255 blue:193./255 alpha:1];
...
- (void)startRain {
 ...
 //   dropBtn.opaque = YES;
    ...
    [self.gravity addItem:dropBtn];
    [self.collider addItem:dropBtn];
